...
def get_aws_client(client_type: str):
    ...
    if LOCALSTACK:
        ...
        return boto3.client(client_type, region_name=REGION, endpoint_url=LOCALSTACK_ADDRESS)
    else:
...
def get_aws_resource(resource_type: str):
    ...
    if LOCALSTACK:
        ...
        return boto3.resource(resource_type, region_name=REGION, endpoint_url=LOCALSTACK_ADDRESS)
    else:
